...
I am currently in the process of applying to PhD programs
so if you *are* a CS professor...
Entering this site has downloaded a randsom-ware virus automatically.
...
> For legal purposes, the above ~~threat~~ notice is what we here on the internet
  like to call: *a joke*.

Here's a formula I really like so that I can test out math rendering.
$$
\frac{ {\mathbb R}[x] }{ (x^2+1) } = {\mathbb C}
$$
